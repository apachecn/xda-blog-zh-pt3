...
我不是脸书或其信息平台的最大粉丝。但事实是，它拥有庞大的用户群，并且可以通过 Wi-Fi 访问。Facebook Messenger Kids 是一种“更安全”的方式，让孩子们可以使用成人版本的功能，但有限制和家长监督。我儿子的许多朋友都可以使用这项服务，并询问他们是否可以用它与他聊天，但因为他的 Gabb Phone Plus 上没有该应用程序，他无法用他的手机给他们发消息。
