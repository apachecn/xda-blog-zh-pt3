...
> 原文：<https://www.xda-developers.com/best-weather-app-widget-android/>
...
[AccuWeather](https://play.google.com/store/apps/details?id=com.accuweather.android) 可能是这个列表中最突出的名字，它甚至被许多上述应用程序用作天气数据源。它也是 Google Play 商店下载量最大的天气应用之一。它的新界面简洁明了，以一种易读的方式提供超本地和准确的天气信息。
...
来自 YoWindow 的[令人敬畏的天气](https://play.google.com/store/apps/details?id=yo.app.free)是一款有趣的 Android 天气应用。它显示你所在位置的天气实况，并配有声音。十种景观可供选择，以防你喜欢其中一种。你甚至可以创造自己的风景。在天气数据方面，该应用程序从各种来源获得信息，包括国家气象局(NWS)、Aerthe is the weather、Foreca (nowcasting)、yr.no (met.no)、METAR 和 Open Weather Map。你可以查看长达 14 天的天气预报。
...
与此同时，如果你正在寻找更多令人惊叹的 Android 应用，我们已经选出了总体[最佳 Android 应用](https://www.xda-developers.com/best-android-apps/)、最佳消息应用[、以及最佳儿童应用](https://www.xda-developers.com/best-text-messaging-apps-android/)。