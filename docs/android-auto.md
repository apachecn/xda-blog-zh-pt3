...
**注意:** Android Auto for Phone Screens 将不再在运行 [Android 12](https://www.xda-developers.com/android-12/) 的设备上工作，谷歌证实了这一点。相反，运行 Android 12 的手机可以使用助手的驾驶模式。不过在老款设备上，你仍然可以继续使用 Android Auto for Phone Screens 应用。
