# 惠普蜻蜓 Folio G3 与惠普 Spectre x360 13.5:你应该买哪个？
...
## 惠普蜻蜓 Folio G3 与惠普 Spectre x360 13.5:定价和可用性
...
Spectre x360 13.5 坚持采用更传统的设置，扬声器安装在机箱底部面板的两侧。音频质量仍然很好，但不如 Folio G3 先进。然而，它足以处理电影和电视以及与同事、朋友和家人的通话。
