...
> 原文：<https://www.xda-developers.com/best-android-root-apps/>
...
**[XDA Tasker 温馨提示&招数论坛](https://forum.xda-developers.com/f/tasker-tips-tricks.5015/)**

* * *

## 备份和恢复

[备份数据并在 Android 上恢复数据](https://www.xda-developers.com/how-to-backup-android)可能是一项痛苦的工作。多亏了这些应用程序，有了 root 用户，事情就简单多了。
...
LiveBoot 是一个独特的启动动画应用程序，在设备启动时向您显示 [logcat 和 dmesg](https://www.xda-developers.com/how-to-take-logs-android/) 的输出。修改者不仅认为它是比 OEM 徽标更好的启动动画，而且它也很有用，因为它可以在错误发生时向您显示这些日志中的错误。

**live boot:[GitHub Repo](https://github.com/Chainfire/liveboot)| |[XDA 讨论线程](https://forum.xda-developers.com/t/2976189/)**
...
AdAway 是一款免费的开源广告拦截器，它使用 hosts 文件来拦截提供广告服务的主机名。它本质上做的是保存一个广告服务网络的更新列表，并将它们重定向到本地主机(即您自己的电话)，因此这些请求不会到达任何地方，也不会提供任何广告。该应用程序也有非 root 模式，但它与 root 配合使用效果最好。

**AdAway:[GitHub Repo](https://github.com/AdAway/AdAway)| |[XDA 讨论线程](https://forum.xda-developers.com/t/2190753/)**
...
**BetterBatteryStats:[XDA 下载讨论线程](https://forum.xda-developers.com/t/1179809/)**
...
Storage Isolation 是一个应用程序，其工作原理与 Android 的[范围存储](https://developer.android.com/training/data-storage#scoped-storage)功能相同，并让您管理应用程序如何使用您的存储。顾名思义，您可以选择要隔离哪些应用程序，以及要授予哪些应用程序对共享存储的完全访问权限。
...
**Termux:[GitHub Repo](https://github.com/termux)**
...
如果你曾经关心过[在你的 Android 设备上闪烁一个定制内核](https://www.xda-developers.com/most-popular-custom-kernels-for-android/)，那么你可能听说过像 EX 内核管理器、Franco 内核管理器等内核管理器应用。用户可以利用这些应用来调整 CPU 控制器、改变时钟速度和电压值、调整调度程序等等。

### 日志阅读器应用程序

在记录你的 Android 设备正在做什么的时候，有很多选项可供选择。无论是出于调试或报告问题的目的，还是想通过 PC 或直接从设备上获取日志，[你有无数的选择](https://www.xda-developers.com/how-to-take-logs-android/)。使用 root 访问权限，日志阅读器应用程序可以轻松地连接到许多其他方式无法读取的源。

### Magisk 模块

在 Android 设备上释放超级用户权限的许多不同方法中，Magisk 无疑是最好的。由于它的无系统界面和对附加模块的[支持，你可以调整、增强和增加设备的功能。](https://www.xda-developers.com/best-magisk-modules/)

### 暴露模块

由 Xposed 框架支持， [Xposed 模块](https://www.xda-developers.com/best-xposed-modules/)是直接插入到你的操作系统中的小应用程序，让你完全控制你的 Android 设备的功能。
