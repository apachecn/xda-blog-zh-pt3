...
苹果 M1 和 M2 芯片不需要主动冷却，MacBook Air 型号没有风扇，但 MacBook Pro 型号有。GeekBench 基准测试相对较短，因此不会对这些结果产生影响。不过，在较长时间的使用中，MacBook Pro 的性能可能会比 Air 更好，因为它有一个主动冷却风扇。不过这只是 CPU 对比，还有其他值得牢记的地方。
