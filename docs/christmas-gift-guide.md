...
华为的 FreeBuds Pro 是 T2 最受好评的无线耳塞之一。它有一个相对干净的设计，与市场上大多数其他耳塞相比，它的耳塞柄更短，而且它可以说是我们测试过的耳塞中最好的透明模式和主动噪音消除。后者尤其令人印象深刻——华为开发了这项名为“动态噪音消除”的技术，允许耳塞分析用户的周围环境，并相应地调整噪音消除的水平。
